...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Create instances to store stats and display score.
    ...
    def run_game(self):
        ...
        while True:
            self._check_events()
            if self.run and self.stats.game_active:
                self.ship.update()
    ...
    def _fire_bullet(self):
        ...
        if len(self.bullets) < self.settings.bullets_allowed \
                and self.run and self.stats.game_active:
    ...
    def _create_fleet(self):
        ...
        # Spacing between two aliens is one alien's space.
        alien = Alien(self)
        ...
        # Determine number of rows in a screen
    ...
    def _create_alien(self, alien_number:int, row_number:int):
        ...
        # alien.rect.x = alien_width + 2 * alien_width * alien_number doesn't work
    ...
    def _update_aliens(self):
        ...
        # Look for aliens hitting the bottom of the secret.
    ...
    def _check_aliens_bottoms(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat like it hit the ship.
                self._ship_hit()
                break

    def _start_new_level(self):
        """Start a new level when all aliens have been shot down."""
    ...
    def _update_screen(self):
        ...
        for bullet in self.bullets.sprites():
            bullet.draw_bullet()
        # self.bullets.draw(self.screen) doesn't work since we have rendered it.
